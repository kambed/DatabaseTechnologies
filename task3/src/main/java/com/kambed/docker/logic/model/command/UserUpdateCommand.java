...
public class UserUpdateCommand {
    ...
    @Schema(description = "User ID", example = "60f3e3e3e4b0e3f3e4b0e3f3", requiredMode = Schema.RequiredMode.REQUIRED)
    @Size(max = 24, message = "The user ID does not meet the text length requirements")
    private String id;
